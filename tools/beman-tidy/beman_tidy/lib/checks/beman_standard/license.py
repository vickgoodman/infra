...
class LicenseApprovedCheck(LicenseBaseCheck):
    ...
    def check(self):
        ...
        separator_line = "=============================================================================="
        approved_licenses = ["Apache License v2.0 with LLVM Exceptions", "Boost Software License 1.0", "MIT License"]
        ...
        for approved_license in approved_licenses:
            if (license_header[0] == separator_line
            and license_header[1] == f"The Beman Project is under the {approved_license}:"
